module LordBowser
  ...
  class Browser
    ...
    def mobile?
      if user_agent
        MOBILE_BROWSER_R1.match(user_agent) or MOBILE_BROWSER_R2.match(user_agent[0..3])
      end
    end
